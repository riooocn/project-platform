...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            [
                'name' => '2002 SNEAKERS SHOES',
                'brand' => 'NEW BALANCE',
                'category' => 'Men',
                'color' => 'Grey',
                'slug' => Str::slug('2002 SNEAKERS SHOES'),
                'price' => 2499000,
            ...
            [
                'name' => 'AIR JORDAN 1 RETRO HIGH OG BASKETBALL SHOES',
                'brand' => 'NIKE',
                'category' => 'Men',
                'color' => 'White',
                'slug' => Str::slug('AIR JORDAN 1 RETRO HIGH OG BASKETBALL SHOES'),
                'price' =>2279200,
                'description' => 'shoes ',
            ...
            [
                'name' => 'AIR MAX PLUS SNEAKERS SHOES',
                'brand' => 'NIKE',
                'category' => 'Men',
                'color' => 'Black',
                'slug' => Str::slug('AIR MAX PLUS SNEAKERS SHOES'),
                'price' =>2218300,
                'description' => 'from .',
            ...
            [
                'name' => 'AIR MAX 1 SNEAKERS SHOES',
                'brand' => 'NIKE',
                'category' => 'Men',
                'color' => 'Sail',
                'slug' => Str::slug('AIR MAX 1 SNEAKERS SHOES'),
                'price' =>2199000,
                'description' => 'Adidas.',
            ...
            [
                'name' => '180 PERF SNEAKERS SHOES',
                'brand' => 'PUMA',
                'category' => 'Men',
                'color' => 'ALPINE SNOW',
                'slug' => Str::slug('180 PERF SNEAKERS SHOES'),
                'price' =>1019400,
                'description' => 'running',
            ...
            [
                'name' => 'AIR FORCE 1 BASKETBALL SHOES',
                'brand' => 'NIKE',
                'category' => 'Men',
                'color' => 'BLACK',
                'slug' => Str::slug('AIR FORCE 1 BASKETBALL SHOES'),
                'price' =>2099000,
                'description' => 'Comfortable running shoes from Adidas.',
            ...
            [
                'name' => '610 SNEAKERS SHOES',
                'brand' => 'NEW BALANCE',
                'category' => 'Men',
                'color' => 'GREEN',
                'slug' => Str::slug('610 SNEAKERS SHOES'),
                'price' =>1999000,
                'description' => 'Comfortable running shoes from Adidas.',
